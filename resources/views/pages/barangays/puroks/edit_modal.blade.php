<!--Start Edit Purok-->
<div id="edit-purok" class="modal fade" role="dialog">  
                        ...
                        <div class="panel-body">
                            <div class="form-group row">
                                <label class="col-md-4 control-label">Purok Name</label>
                                  <div class="col-md-6">
                                      <input type="text" class="form-control" name="name" value="1A" required>
                                  </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 control-label">Description</label>
                                  <div class="col-md-6">
                                      <input type="text" class="form-control" name="name" value="Safest Place" required>
                                  </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 control-label">President</label>
                                  <div class="col-md-6">
                                      <input type="text" class="form-control" name="name" value="Duterte" required>
                                  </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-md-4 control-label">Population</label>
                                  <div class="col-md-6">
                                      <input type="text" class="form-control" name="name" value="100000" required>
                                  </div>
                            </div>
                        </div>
                    </form>
